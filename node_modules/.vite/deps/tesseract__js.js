...
var require_defaultOptions2 = __commonJS({
  "node_modules/tesseract.js/src/worker/browser/defaultOptions.js"(exports, module) {
    ...
    var { version, dependencies } = require_package();
      ...
      loadImage.transform = function(img, options, callback, file, data) {
        if (loadImage.hasMetaOption(options)) {
          loadImage.parseMetaData(
            file,
            function(data2) {
              originalTransform.call(loadImage, img, options, callback, file, data2);
            },
            options,
            data
          );
      ...
      loadImage.parseExifData = function(dataView, offset, length, data, options) {
        ...
        if (dirOffset && !options.disableExifThumbnail) {
          ...
          if (data.exif[513] && data.exif[514]) {
            data.exif[513] = getExifThumbnail(
              dataView,
              tiffOffset + data.exif[513],
              data.exif[514]
...
var require_loadImage = __commonJS({
  "node_modules/tesseract.js/src/worker/browser/loadImage.js"(exports, module) {
    var resolveURL = require_resolve_url();
    var blueimpLoadImage = require_js();
    ...
    var fixOrientationFromUrlOrBlobOrFile = (blob) => new Promise((resolve) => {
      blueimpLoadImage(
        blob,
